...
| Document | Purpose |
|---|---|
| [Architecture](architecture.md) | boundaries, state ownership and end-to-end request flow |
| [RAG handbook](rag-handbook.md) | RAG variants, chunking decisions, OCR and evaluation |
| [Agents and protocols](agents-and-protocols.md) | ADK, MCP, A2A and Agents CLI |
| [Production guide](production-guide.md) | speed, scale, failures, security and telemetry |
